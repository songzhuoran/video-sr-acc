...
REMAP_RES_DIR = "/home/songzhuoran/video/video-sr-acc/code/cluster-scheme/remap/remap_result_REDS/"
PICS_DIR = "/home/songzhuoran/video/video-sr-acc/REDS/BIx4/"
HR_PICS_DIR = "/home/songzhuoran/video/video-sr-acc/REDS/GT/"
SR_PICS_DIR = "/home/songzhuoran/video/video-sr-acc/REDS/SR_result/"

SLICES_OUT_DIR = 'slice_result_REDS/GT_SR/'

def fetch_res_data():
    #load the whole res_data file into a py list. prevent redundant loading
    with open(REMAP_RES_DIR + "new_remap_"+classname + "_20GT.csv", "r") as file:
