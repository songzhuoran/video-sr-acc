...
SLICES_OUT_DIR = '/home/songzhuoran/video/video-sr-acc/train_info/Sintel_Cluster_remap/GT_SR/'
...
def remapSliceKernel(fidx, mvs_data, slice_dict):
    '''
...
# classnameList = ['city']
# classnameList = ['013','014','015','016','017','018','019','020','021','022','023','024','025','026','027','028','029']
...
for classname in classnameList:
    ...
    for i, fidx in enumerate(bframeGenList):
        p = Process(target=remapSliceKernel, args=(fidx, shareMvs, dic))
        childList.append(p)
        p.start()
